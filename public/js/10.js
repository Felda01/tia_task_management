    ...
    filteredTasks: function filteredTasks() {
      ...
      if (this.project.tasks && this.project.tasks.length > 0) {
        switch (this.taskSort) {
          ...
          case "priority-asc":
            {
              return _.sortBy(this.project.tasks, function (e) {
  ...
  methods: {
    fetchData: function fetchData() {
      ...
      this.axios.get('/api/projects/' + this.$route.params.slug).then(function (response) {
        ...
        _this2.projectStatusOptions = response.data.meta.projectStatusOptions;
        _this2.taskStatusOptions = response.data.meta.taskStatusOptions;
        _this2.taskPriorityOptions = response.data.meta.taskPriorityOptions;
        _this2.allUsers = response.data.meta.allUsers.data;
